...
from nested_list_lab import count_all
...
class CountAllTests(unittest.TestCase):
    ...
    def test_integer(self):
        ...
        """
        self.assertEqual(count_all(1), 1, "count_all should return 1 " +
                         "when passed a single integer.")

    def test_one_nested_sublist(self):
        """
        Test list_even on a list with only one sublist in it.
        """
        self.assertEqual(count_all([[2]]), 1, "count_all should return " +
    ...
    def test_one_nested_sublist_and_integers(self):
        ...
        """
        self.assertEqual(count_all([[2], 3, [4]]), 3,
                         "count_even should return the number of " +
